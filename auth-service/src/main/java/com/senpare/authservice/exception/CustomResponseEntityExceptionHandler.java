...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleBadCredentials(RuntimeException exception, WebRequest request) {
        System.out.println("handleBadCredentials");
        log.debug(exception.getMessage());
        Sentry.captureMessage(exception.getMessage(), SentryLevel.DEBUG);
        return handleExceptionInternal(exception, prepareErrorResponse( exception.getMessage(), null), new HttpHeaders(), HttpStatus.UNAUTHORIZED, request);
    }
